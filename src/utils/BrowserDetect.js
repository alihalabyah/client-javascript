qmonix.utils.BrowserDetect = new function() {
        var self = this;

	this.detect = function () {
		var browser = self.searchString(self.dataBrowser) || "An unknown browser";
		var version = self.searchVersion(navigator.userAgent)
			|| self.searchVersion(navigator.appVersion)
			|| "an unknown version";
		var OS = self.searchString(self.dataOS) || "an unknown OS";
